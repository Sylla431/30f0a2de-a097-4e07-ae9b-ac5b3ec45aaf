  ...
  return {
    ...
    visitor: {
      ...
      JSXOpeningElement(path, state) {
        ...
        // Skip native DOM elements (lowercase tag names like iframe, div, span, etc.)
        // They don't accept `dataSet` prop and React warns about unrecognized props.
        if (t.isJSXIdentifier(elementName) && /^[a-z]/.test(elementName.name)) return;
